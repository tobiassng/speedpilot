...
/// In the class Tachometer, a Tachometer is built which is supposed to visualize the actual speed of the car
/// The speed is received from the WebSocket and is updated nearly in real time
